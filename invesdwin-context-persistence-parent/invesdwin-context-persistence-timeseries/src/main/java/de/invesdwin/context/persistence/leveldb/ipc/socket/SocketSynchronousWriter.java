package de.invesdwin.context.persistence.leveldb.ipc.socket;
...
@NotThreadSafe
public class SocketSynchronousWriter extends ASocketSynchronousChannel implements ISynchronousWriter {
