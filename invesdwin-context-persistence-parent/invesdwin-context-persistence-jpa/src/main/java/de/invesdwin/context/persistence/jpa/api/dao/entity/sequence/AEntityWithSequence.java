...
@MappedSuperclass
@NotThreadSafe
public abstract class AEntityWithSequence extends AUnversionedEntityWithSequence {
    ...
    @Override
    public AEntityWithSequence clone() {
        return (AEntityWithSequence) super.clone();
    }
