...
@MappedSuperclass
@NotThreadSafe
public abstract class AEntityWithTableSequence extends AUnversionedEntityWithTableSequence {
    ...
    @Override
    public AEntityWithTableSequence clone() {
        return (AEntityWithTableSequence) super.clone();
    }
