...
public abstract class AUnversionedEntityWithSequence extends AValueObject implements IEntity {
    ...
    @Id
    //not defining a name, so that one sequence per entity should be used
    ...
    @Override
    public AUnversionedEntityWithSequence clone() {
    ...
    public boolean equals(final Object obj) {
        if (obj instanceof AUnversionedEntityWithSequence && id != null) {
            final AUnversionedEntityWithSequence cObj = (AUnversionedEntityWithSequence) obj;
