...
@NotThreadSafe
public abstract class ANoGapValuesBaseDBWithNoCacheAndNoQueryCacheTest extends ARootDBTest {
    ...
    public void testGapsWithReturnMaxResults() {
        ...
        Assertions.assertThat(countReadAllValuesAscendingFrom).isEqualTo(40);
        Assertions.assertThat(countReadNewestValueTo).isEqualTo(6);
    }
