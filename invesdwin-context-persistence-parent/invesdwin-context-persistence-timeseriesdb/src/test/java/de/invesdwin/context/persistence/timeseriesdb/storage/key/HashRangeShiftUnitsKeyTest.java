...
public class HashRangeShiftUnitsKeyTest extends ATest {
    ...
    public void testCompare() {
        ...
        sortedKeys.add(new HashRangeShiftUnitsKey("1", 0, 0, FDateBuilder.newDate(1900), Integer.MAX_VALUE)); //0
        sortedKeys.add(new HashRangeShiftUnitsKey("1", 0, 0, FDateBuilder.newDate(2000), 1)); //1
        sortedKeys.add(new HashRangeShiftUnitsKey("1", 0, 0, FDateBuilder.newDate(2000), 2)); //2
        sortedKeys.add(new HashRangeShiftUnitsKey("1", 0, 0, FDateBuilder.newDate(2001), 2)); //3
