...
// CHECKSTYLE:OFF
@NotThreadSafe
public class AShiftBackUnitsLoopIntIndexTest extends ATest {
    //CHECKSTYLE:ON
    ...
    public void testShiftBackward() {
        for (int shiftBackUnits = 0; shiftBackUnits < DATES.size(); shiftBackUnits++) {
            for (int i = 0; i < DATES.size(); i++) {
                ...
                final AShiftBackUnitsLoopIntIndex<FDate> loop = newLoop(request, shiftBackUnits);
                loop.loop();
                ...
                final AShiftBackUnitsLoopIntIndex<FDate> loopMinus = newLoop(requestMinus, shiftBackUnits);
                loopMinus.loop();
                ...
                final AShiftBackUnitsLoopIntIndex<FDate> loopPlus = newLoop(requestPlus, shiftBackUnits);
                loopPlus.loop();
    ...
    private AShiftBackUnitsLoopIntIndex<FDate> newLoop(final FDate request, final int shiftBackUnits) {
        return new AShiftBackUnitsLoopIntIndex<FDate>(request, shiftBackUnits) {
