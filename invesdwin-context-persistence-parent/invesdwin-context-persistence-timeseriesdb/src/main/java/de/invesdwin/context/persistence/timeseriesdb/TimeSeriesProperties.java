...
public final class TimeSeriesProperties {
    ...
    public static final Duration RETAIN_OBSOLETE_FILES_DURATION;
    ...
    static {
        ...
        RETAIN_OBSOLETE_FILES_DURATION = SYSTEM_PROPERTIES.getDuration("RETAIN_OBSOLETE_FILES_DURATION");
