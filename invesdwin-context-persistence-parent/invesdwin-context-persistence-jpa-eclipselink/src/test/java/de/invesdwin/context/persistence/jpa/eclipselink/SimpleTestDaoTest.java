...
public class SimpleTestDaoTest extends APersistenceTest {
    ...
    private class TransactionalAspectMethods {
        ...
        public void testDeleteWithoutTransaction() {
            ...
            Assertions.assertThat(ent1Resurrected1.getId()).isEqualTo(ent1.getId());
            final SimpleTestEntity ent1Resurrected2 = dao.save(ent1);
            Assertions.assertThat(ent1Resurrected2.getId()).isEqualTo(ent1.getId());
            Assertions.assertThat(ent1Resurrected1.getId()).isEqualTo(ent1Resurrected2.getId());
        }
