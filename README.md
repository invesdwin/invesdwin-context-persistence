...
```
     ...
     InfluxDB     1,000,000    Writes:     200.84/ms  => ~30 percent faster than LevelDB
     InfluxDB    10,000,000     Reads:     649.31/ms  =>  ~2 times   slower than LevelDB (likely due to network overhead)
ATimeSeriesDB     1,000,000    Writes:   4,759.64/ms  => ~30 times   faster than LevelDB
