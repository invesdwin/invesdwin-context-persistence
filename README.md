...
The `invesdwin-context-persistence-timeseries` module provides support for the popular [LevelDB](https://github.com/google/leveldb) key-value storage via [JNI](https://github.com/fusesource/leveldbjni). The actual LevelDB API is very low level, so we use [EZDB](https://github.com/criccomini/ezdb) for a bit more comfort. Our module provides the following accessories::
